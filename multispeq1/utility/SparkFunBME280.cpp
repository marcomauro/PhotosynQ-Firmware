...
//
//****************************************************************************//
uint8_t BME280::begin(int address)
{
        settings.I2CAddress = address;   // JZ - we use two chips
	...
	case I2C_MODE:
		//Wire.begin();   // JZ - we have already done Wire.begin
		break;
...
float BME280::readAltitudeFeet( void )
{
	float heightOutput = 0;
